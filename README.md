...
关键词：ROBOCON、四足、四轮足、仿生足式、机器狗、强化学习、RL、Mjlab、Mujoco、Odin1、sim2sim、sim2real、全开源。
...
* 当前版本：`v1.1.0` 整理 ROS 2/C++ 最终版本、导航原型与最终比赛部署代码；
* 相关注意事项以及各类文档仍在持续补充
...
> 由于资料较多，仓库内容会在整理完毕后分阶段发布，请以各目录说明和 Git Tag 对应的版本为准。
