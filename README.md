...
感谢Robocon青年顾问组对本战队的帮助与支持，感谢[Lain 佬](https://github.com/Lain-Ego0) 的 [LocoWiki](https://github.com/LocoWiki/LocoWiki) 项目对早期方案的参考与启发，衷心感谢哈尔滨工业大学、华南理工大学、东莞理工学院、潍坊科技学院、山东科技大学、太原工业学院、晋中信息信息学院等院校的战队，在备赛及比赛期间给予我们的鼎力支持与热心帮助。
...
* `v0.5.0` 已增强观测噪声、延迟、动力学随机化和持续外力扰动配置；
* `v0.6.0` 已整理比赛最终训练架构，包含分轴奖励、自适应指令课程、障碍释放课程、比赛站姿和训练诊断指标；
