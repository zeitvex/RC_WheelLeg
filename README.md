...
|成员|方向|主要职责|联系方式|
|-|-|-|-|
|[晨小荼](https://github.com/chentu12)|队长 / 算法|构建初创平台；前期负责 8DOF 平台构建与算法，参与硬件和算法方案讨论；后期负责 16DOF 轮足机器人 Odin1 平台建设与硬件实现，负责企业及组委对接，持续推进项目落地。|WX: `r15288746596`<br>QQ: `2898468947`|
...
|[王书琪](https://github.com/JadeCrane)|机械 / 硬件|负责整机机械结构设计与电气硬件系统搭建；负责 8DOF 开源机械结构的硬件适配，以及 16DOF 架构整体机械结构的建模、优化和 CNC 供应链对接；负责电源管理 PCB 设计与 CAN 总线通信拓扑，为算法和仿真部署提供高刚度、高稳定性的硬件基础。|WX: `DouSfJade`<br>QQ: `3070940094`|
